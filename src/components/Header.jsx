...
function Navbar () {
  ...
  return (
    <nav className=' lg:bg-white z-50 py-3 w-full top-0 sticky'>
      <div className='max-width mx-auto px-4 sm:px-6 '>
        <div className='flex items-center justify-between h-14'>
          <div className='flex items-center space-x-4 text-black'>
            <a to='/' className='pb-6'>
              <img src={Logo} alt='' className='mr-8' />
            </a>
            <div className='lg:flex items-center space-x-16 hidden'>
              <a href='' className='text-slate-400 hover:text-black pb-6 hover:border-b-4 hover:border-[#FF7D1A] '>
                Collections
              </a>
              <a href='' className='text-slate-400 hover:text-black pb-6'>
                Men
              </a>
              <a href='' className='text-slate-400 hover:text-black pb-6'>
                Women
      ...
      <div className='h-1  bg-gray-950 hidden lg:block' />
    </nav>
  )
}
